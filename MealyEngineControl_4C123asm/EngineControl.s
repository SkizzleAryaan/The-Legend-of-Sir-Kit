...
Start
    ...
    LDR R0, [R1]
    MOV R2, #0x00000FFF
    BIC R0, R0, R2          ; clear port control field for PB2-0
    STR R0, [R1]
    LDR R1, =GPIO_PORTB_AMSEL_R
    LDR R0, [R1]
    BIC R0, R0, #0x07 ; disable analog functionality on PB2-0
    STR R0, [R1]
    LDR R1, =GPIO_PORTB_DIR_R
    LDR R0, [R1]
    BIC R0, R0, #0x01 ; PB0 input
    ORR R0, R0, #0x06 ; PB2-1 output
    STR R0, [R1]
