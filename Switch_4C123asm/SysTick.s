...
; the system clock to 16 MHz.  This matters for the function
...
; Input: R0  delay parameter in units of the core clock (units of 62.5 nsec for 16 MHz clock)
; Output: none
; Modifies: R0, R1, R3
SysTick_Wait
    LDR  R1, =NVIC_ST_RELOAD_R      ; R1 = &NVIC_ST_RELOAD_R
...
; Output: none
; Modifies: R0
DELAY10MS  EQU 160000    ; clock cycles in 10 ms (assumes 16 MHz clock)
SysTick_Wait10ms
